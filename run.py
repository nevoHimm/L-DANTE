"""
This part of the code is an Image Caption Generator, developed by Vinayak Sharma, full code is available at:
https://github.com/vinayaksharmagh/IMcap/blob/master/README.md
"""
...
class DECODER(tf.keras.Model):
    ...
    def __init__(self, units, embed_M, sentence_length):
        ...
        # self.embed = tf.keras.layers.Embedding(input_dim=embed_M.shape[0], output_dim=embed_M.shape[1],
        # embeddings_initializer=tf.keras.initializers.Constant(embed_M), input_length=sentence_length, trainable=True)
